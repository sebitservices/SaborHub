    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        <div className="flex justify-between items-center p-4 border-b rounded-t-lg">
          ...
          <button
            onClick={!loading ? onClose : undefined}
            className="text-emerald-600 hover:text-emerald-900 transition-colors focus:outline-none focus:ring-2 focus:ring-emerald-500 rounded-full p-1"
            disabled={loading}
          >
        ...
        <div className="p-6 text-center">
          ...
          {success ? (
            <div className="animate-fadeIn">
              ...
              <h3 className="text-lg font-medium text-green-900 mb-2">¡Categoría eliminada!</h3>
            ...
            <>
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">¿Eliminar esta categoría?</h3>
              <p className="text-sm text-gray-500 mb-4">
                Estás a punto de eliminar la categoría <span className="font-semibold">{category?.nombre}</span>. 
                Esta acción no se puede deshacer y podría afectar a los productos asociados a esta categoría.
              </p>
