...
const DeleteProviderModal = ({ isOpen, onClose, onConfirm, provider }) => {
        ...
        <div className="p-6 text-center">
          ...
          {success ? (
            <div className="animate-fadeIn">
              ...
              <h3 className="text-lg font-medium text-green-900 mb-2">¡Proveedor eliminado!</h3>
            ...
            <>
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">¿Eliminar este proveedor?</h3>
              <p className="text-sm text-gray-500 mb-4">
                Estás a punto de eliminar al proveedor <span className="font-semibold">{provider?.nombre}</span>. 
